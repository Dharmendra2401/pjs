...
<input type="tel" class="form-control" maxlength="15" name="mobile" placeholder="Enter your mobile no" onKeyPress="return isNumeric(event)" required>
</div>

<div class="form-group">
<label>Email <span class="text-danger">*</span></label>
<input type="email" class="form-control" name="email" id="email" onchange="return checkEmail();" placeholder="Enter your email" required>
