		...
		<div class="container shadow">
			...
			<div class="row">
				<div class="col-md-12 tab-content">
					...
					<div class="col-md-3"> <select class="custom-select form-control" id="state" onchange="return getCity();" name="state">
    	...
    	function BtnClickPage(x,y)
{
  ...
  type: 'POST',
  url: "load_open.php",
  data: {"page":x,"pagesize":y,"state":state,"city":city,"submitdate":submitdate},
...
function BtnClickPagetwo(x,y)
{
  ...
  type: 'POST',
  url: "load_close.php",
  data: {"page":x,"pagesize":y,"statetwo":statetwo,"citytwo":citytwo,"submitdatetwo":submitdatetwo},
