...
$('#content').focus();
$("#contenterror").html("<span class='text-danger'>Please fill out the content</span>");
return false;   
}
...
bootbox.confirm("Are you sure you want to make this event active ?", function(result) {
if(result) {
$('#loadergif').fadeIn();
$.ajax({
type: 'POST',
...
bootbox.confirm("Are you sure you want to make this event inactive ?", function(result) {
if(result)
{  
$('#loadergif').fadeIn();
$.ajax({
