...
mysqli_query($con,'insert into gallery (title,short_image,long_image,record_inserted_dttm,status) values("'.$title.'","'.$image.'","'.$url12.'","'.$submitdate.'","Y")');

redirect(RE_HOME_SUPERADMIN."gallery.php","Record successfully created~@~".MSG_SUCCESS);
}
redirect(RE_HOME_SUPERADMIN."gallery.php","Error!Please try again~@~".MSG_ERROR);
...
<h3 class="ticket-header">Gallery List </h3>
<div class="row"> 
...
<div class="col-md-4 form-group">
<button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#add"><i class="fa fa-user-plus"></i> Add Gallery</button>
</div>
</div>
