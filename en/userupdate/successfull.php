...
<br><br>
<div class="text-light bg-info text-center rounded" style="padding: 30px 0 30px;">
<h5 class="text-light">You have been successfully updated your profile.</h5><br>
Please <a class="btn btn-warning" href="<?php echo RE_HOME_PATH; ?>">click here</a> to redirect 
</div>
</div>
</div>
</body>
