...
var refrenceid=$("#refrenceid").val();
var memberid=$("#memberidone").val();
 window.location.replace("<?php echo RE_HOME_ADMIN; ?>reports/death_reports.php/?state="+ state+"&refrenceid="+ refrenceid+"&memberid="+ memberid);
}
