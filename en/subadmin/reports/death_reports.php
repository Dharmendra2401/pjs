...
// if($_REQUEST['state']!='')
// {
// $stt=explode(',',$_REQUEST['refrenceid']);
// $state=Implode('","',$stt);    
...
<th style="width:150px">Date Of Death</th>
...
if($row['status_of_request']=='Y'){$states= "New";} else if($row['status_of_request']=='R'){$states= "Rejected";} else{ $states= "Closed"; }
...
header('Content-Disposition: attachment; filename=death-users.xls');
