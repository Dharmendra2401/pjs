...
{$statu.= 'and request_date LIKE "%'.date('Y-m-d',strtotime($_REQUEST['submitdatetwo'])).'%"';}
...
$stat="non_member_request where 1=1 and request_status='N' $statu order by request_id desc";
...
<td><a class="btn btn-success btn-sm" href="<?php echo RE_HOME_ADMIN;?>contact_user_detail.php?id=<?php echo base64_encode($row['request_id']);?>">Show Details</a></td>
</tr>
<?php $count++; }
if($row_count<=0){
?>
