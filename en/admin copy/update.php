...
$mes='';
$mes.=" Dear ".$subadmin['first_name']." ".$subadmin['last_name'].", you are successfully approved as SUB ADMIN and your login crediential is <br> Email :<strong>".$subadmin['email']."</strong> <br> Password :<strong>".base64_decode($subadmin['password'])."</strong><br> <a href='".RE_HOME_ADMIN."'>Click here</a> to login now. if any query email us <a href='".FROM_EMAIL."'>".FROM_EMAIL."</a>";
$message=$mes;
$to=$subadmin['email'];
