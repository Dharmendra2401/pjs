...
if(($opjfirstname!='') && ($opjlastname!='') && ($opjmobile!='') && ($opjemail!='') && ($opjaddress!='') && ($userid!='')){mysqli_query($con,'insert into non_member_request(request_id,first_name,last_name,mobile,email,address,user_id,request_date,request_status)values("'.$request_id.'","'.$opjfirstname.'","'.$opjlastname.'","'.$opjmobile.'","'.$opjemail.'","'.$opjaddress.'","'.$userid.'","'.$submitdate.'","Y")');
