...
$mes='';
$mes.=" Dear ".$opjfirstname." ".$opjlastname.", you are succesfully registered as OPJ user with ".WEBSITE_NAME." and your REFRENCE ID is <strong>".$request_id."</strong> .if any query email us <a href='mailto:".FROM_EMAIL."'>".FROM_EMAIL."</a>";
$message=$mes;
$to=$email;
