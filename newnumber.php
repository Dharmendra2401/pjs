...
$mes='';
$mes.=" Dear User, you are successfully submited form for mobile updation  with ".WEBSITE_NAME." and wait till the approval mail of admin .if any query email us <a href='mailto:".FROM_EMAIL."'>".FROM_EMAIL."</a>";
$message=$mes;
$to=$emailidget['email'];
