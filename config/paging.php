...
function paginationjquery($con,$query, $per_page = 10,$page = 1, $url = '?',$type=""){  
...
function paginationjquerytwo($con,$query, $per_page = 10,$page = 1, $url = '?',$type=""){  
...
$pagination.= "<li><a href='#' onclick='return BtnClickPagetwo(\"".$counter."\",\"".$type."\");'>$counter</a></li>";					
...
$pagination.= "<li><a  href='#' onclick='return BtnClickPagetwo(\"".$lpm1."\",\"".$type."\");'>$lpm1</a></li>";					

$pagination.= "<li><a  href='#' onclick='return BtnClickPagetwo(\"".$lastpage."\",\"".$type."\");'>$lastpage</a></li>";					
...
{        $pagination.= "<li><a href='#' onclick='return BtnClickPagetwo(\"1\",\"".$type."\");'>1</a></li>";					

$pagination.= "<li><a href='#' onclick='return BtnClickPagetwo(\"2\",\"".$type."\");'>2</a></li>";					
...
$pagination.= "<li><a href='#' onclick='return BtnClickPagetwo(\"".$next."\",\"".$type."\");'>Next <i class='fa fa-fw fa-angle-right'></i> </a></li>";										

$pagination.= "<li><a href='#' onclick='return BtnClickPagetwo(\"".$lastpage."\",\"".$type."\");'>Last <i class='fa fa-fw fa-angle-double-right'></i> </a></li>";    
